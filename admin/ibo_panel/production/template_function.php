                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-home"></i>Property<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a href="add_property.php"><i class="fa fa-home"></i>Add Property</a></li>
                        <li><a href="propertyLists.php"><i class="fa fa-home"></i>Property Lists</a></li>
                    </ul>
                  </li> 
                  
                       <li><a href="property_request.php"><i class="fa fa-home"></i>Property Requests</a>
                  </li>
