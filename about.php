        ...
        <div class="container py-lg-5 py-md-4 py-2">
            <div class="row">
                <div class="col-lg-5 pr-lg-0">
                    <div class="w3l-left">
                        <img src="assets/images/dream.jpeg" style="width:100%;height:300px;">
                    </div>
                </div>
                <div class="col-lg-7 pl-lg-0">
                    <div class="w3l-right-info">
                        ...
                        <h5 class="mt-4">We have over 15 year experience.           </h5>
                ...
                <div class="users_box">
                    ...
                    <div class="users_box_info">
                        ...
                        <h4 class="user_title agent">
                            <a href="#agent-single">Saurabh Shukla </a>
                        </h4>
                        <div class="user_meta user_phone">
                            <span class="phone-detail"> <a href="tel:+1-2345-678-11">+91-7878787878</a></span>
                        </div>
